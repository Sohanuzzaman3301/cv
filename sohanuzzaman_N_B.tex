...
\section{Summary}
  \begin{itemize}[leftmargin=0.5cm, label={}]
    \small{\item{Fresh graduate with self-taught Linux daily user and hands-on networking, IT/Cybersecurity and Flutter app development — lab-based operations, alert triage and reporting. Available immediately for IT technical roles.}}
  \end{itemize}
